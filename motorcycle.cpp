...
motorcycle::motorcycle(person arg_person, bool arg_ejection_seat, bool arg_helmet,bool arg_seatbelt, bool arg_airbag){
    ...
    // std::cout<<"motorcycle create success"<< endl;
}
